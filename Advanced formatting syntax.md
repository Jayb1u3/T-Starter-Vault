...
> **! NOTE:** The educational content below related to tables is optional. 
> 
> You can navigate to `Settings > Hotkeys` and search `insert table`. From there you will be able to create your own hotkey for inserting tables into your notes. 
> 
